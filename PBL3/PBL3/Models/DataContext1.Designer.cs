...
// Code is generated on: 5/18/2022 8:54:17 AM
//
...
namespace Pbl3Context
{
    ...
    public partial class Pbl3DataContext : Devart.Data.Linq.DataContext
    {
        ...
        public void CreateNewUser([Parameter(Name="ID", DbType="INT(10)")] int? ID, [Parameter(Name="name", DbType="VARCHAR(255)")] string name, [Parameter(Name="sex", DbType="ENUM")] string sex, [Parameter(Name="phone", DbType="INT(10)")] int? phone, [Parameter(Name="address", DbType="VARCHAR(255)")] string address, [Parameter(Name="username", DbType="VARCHAR(255)")] string username, [Parameter(Name="email", DbType="VARCHAR(255)")] string email, [Parameter(Name="password", DbType="VARCHAR(255)")] string password, [Parameter(Name="status", DbType="VARCHAR(255)")] string status, [Parameter(Name="Idrole", DbType="INT(10)")] int? Idrole)
        {
            IExecuteResult _CreateNewUserResult = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ID, name, sex, phone, address, username, email, password, status, Idrole);
        }
    }
}
...
namespace Pbl3Context
{
    ...
    public partial class Cart : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Cart_Cartdetail", Storage="_Cartdetails", ThisKey="Id", OtherKey="CartId", DeleteRule="NO ACTION")]
    ...
    public partial class Cartdetail : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Cart_Cartdetail", Storage="_Cart", ThisKey="CartId", OtherKey="Id", IsForeignKey=true)]
        public Cart Cart
        {
            get
            {
