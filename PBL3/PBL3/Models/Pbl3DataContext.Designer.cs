...
// Code is generated on: 5/17/2022 6:53:28 PM
//
...
namespace Pbl3Context
{
    ...
    public partial class Pbl3DataContext : Devart.Data.Linq.DataContext
    {
        ...
        partial void InsertProducttotal(Producttotal instance);
        partial void UpdateProducttotal(Producttotal instance);
        partial void DeleteProducttotal(Producttotal instance);
        ...
        public Devart.Data.Linq.Table<Producttotal> Producttotals
        {
            get
            {
                return this.GetTable<Producttotal>();
            }
        }
        ...
        public void CreateNewUser([Parameter(Name="ID", DbType="INT(10)")] int? ID, [Parameter(Name="name", DbType="VARCHAR(255)")] string name,
            [Parameter(Name="sex", DbType="ENUM")] string sex, [Parameter(Name="phone", DbType="INT(10)")] int? phone,
            [Parameter(Name="address", DbType="VARCHAR(255)")] string address, [Parameter(Name="username", DbType="VARCHAR(255)")] string username, [Parameter(Name="emailn", DbType="VARCHAR(255)")] string emailn, 
            [Parameter(Name="password", DbType="VARCHAR(255)")] string password, [Parameter(Name="status", DbType="VARCHAR(255)")] string status, [Parameter(Name="Idrole", DbType="INT(10)")] int? Idrole)
        {
            IExecuteResult _CreateNewUserResult = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), ID, name, sex, phone, address, username, emailn, password, status, Idrole);
        }
    }
}
...
namespace Pbl3Context
{
    ...
    public partial class Cart : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// There are no comments for QuantitySold in the schema.
        /// </summary>
        [Column(Name = @"quantitySold", Storage = "_QuantitySold", DbType = "INT NULL", UpdateCheck = UpdateCheck.Never)]
        public int? QuantitySold
        {
            ...
            set
            {
                if (this._QuantitySold != value)
                {
                    ...
                    this.SendPropertyChanging("QuantitySold");
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_Cart", Storage="_Product", ThisKey="ProductId", OtherKey="Id", IsForeignKey=true)]
    ...
    public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        private EntitySet<Producttotal> _Producttotals;
        ...
        public Product()
        {
            ...
            this._Producttotals = new EntitySet<Producttotal>(new Action<Producttotal>(this.attach_Producttotals), new Action<Producttotal>(this.detach_Producttotals));
            OnCreated();
        }
        ...
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_Cart", Storage="_Carts", ThisKey="Id", OtherKey="ProductId", DeleteRule="NO ACTION")]
        ...
        /// <summary>
        /// There are no comments for Producttotals in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_Producttotal", Storage="_Producttotals", ThisKey="Id", OtherKey="ProductId", DeleteRule="NO ACTION")]
        public EntitySet<Producttotal> Producttotals
        {
            get
            {
                return this._Producttotals;
            }
            set
            {
                this._Producttotals.Assign(value);
            }
        }
        ...
        {
            this.SendPropertyChanging("Carts");
            entity.Product = this;
        }
        ...
        private void attach_Producttotals(Producttotal entity)
        {
            this.SendPropertyChanging("Producttotals");
            entity.Product = this;
        }
    
        private void detach_Producttotals(Producttotal entity)
        {
            this.SendPropertyChanging("Producttotals");
            entity.Product = null;
        }
    ...
    /// <summary>
    /// There are no comments for Pbl3Context.Producttotal in the schema.
    /// </summary>
    [Table(Name = @"pbl3.producttotal")]
    public partial class Producttotal : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        partial void OnProductIdChanging(int? value);
        partial void OnProductIdChanged();
        partial void OnQuantityIntChanging(int? value);
        partial void OnQuantityIntChanged();
        #endregion
        ...
        /// <summary>
        /// There are no comments for QuantityInt in the schema.
        /// </summary>
        [Column(Name = @"quantityInt", Storage = "_QuantityInt", DbType = "INT NULL", UpdateCheck = UpdateCheck.Never)]
        public int? QuantityInt
        {
            get
            {
                return this._QuantityInt;
            }
            set
            {
                if (this._QuantityInt != value)
                {
                    this.OnQuantityIntChanging(value);
                    this.SendPropertyChanging("QuantityInt");
                    this._QuantityInt = value;
                    this.SendPropertyChanged("QuantityInt");
                    this.OnQuantityIntChanged();
                }
            }
        }
        ...
        /// There are no comments for Product in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="Product_Producttotal", Storage="_Product", ThisKey="ProductId", OtherKey="Id", IsForeignKey=true)]
        public Product Product
        {
            get
            {
            ...
            set
            {
                ...
                if ((previousValue != value) || (this._Product.HasLoadedOrAssignedValue == false))
                {
                    ...
                    {
                        this._Product.Entity = null;
                        previousValue.Producttotals.Remove(this);
                    }
                    this._Product.Entity = value;
                    if (value != null)
                    {
                        this._ProductId = value.Id;
                        value.Producttotals.Add(this);
                    }
                    else
                    {
                        this._ProductId = default(int?);
    ...
    public partial class Role : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// </summary>
        [Column(Storage = "_Mota", DbType = "VARCHAR(255) NULL", UpdateCheck = UpdateCheck.Never)]
        public string Mota
        {
            get
            {
            ...
            set
            {
                if (this._Mota != value)
                {
                    ...
                    this.SendPropertyChanging("Mota");
                    this._Mota = value;
    ...
    public partial class User : INotifyPropertyChanging, INotifyPropertyChanged
    {
        ...
        /// There are no comments for Carts in the schema.
        /// </summary>
        [Devart.Data.Linq.Mapping.Association(Name="User_Cart", Storage="_Carts", ThisKey="ID", OtherKey="UserId", DeleteRule="NO ACTION")]
        public EntitySet<Cart> Carts
        {
            get
            {
